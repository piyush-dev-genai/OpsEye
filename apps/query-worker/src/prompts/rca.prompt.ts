  ...
  return [
    {
      ...
      content: [
        ...
        "Use only the retrieved operational evidence provided to you.",
        ...
        "Return JSON only with keys: rootCauseHypothesis, evidenceSummary, uncertainty, recommendedNextSteps, possibleRemediations, confidence, answer.",
        "confidence must be one of: high, medium, low.",
        "evidenceSummary, recommendedNextSteps, and possibleRemediations must be arrays of short strings.",
        "Frame possibleRemediations as candidate actions, not guaranteed fixes.",
        "answer must be RCA-oriented, grounded in evidence, and cover likely issue, why it is likely, supporting evidence, suggested next checks, possible remediation, and uncertainty.",
      ].join(" "),
    },
    {
      role: "user",
